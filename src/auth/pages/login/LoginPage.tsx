        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
            <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md mx-auto">
                ...
                >
                    ...
                    {/* Separador */}
                    <div
                        className="relative text-center text-sm my-6 after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border"
                    >
                        <span className="relative z-10 bg-white px-2 text-muted-foreground">O inicia sesion con</span>
                    </div>
